APP = (function(){
  ...
  var Users = [
    {
      ...
      language: "es",
      avatar: "/demo/images/avatars/1.jpg",
      los: [
        {
          resource_type: "TEXT",
    ...
    },
    {
      name: "Clark DuBuque",
      language: "en",
      avatar: "/demo/images/avatars/2.jpg",
      los: [
        {
          resource_type: "TEXT",
    ...
    },
    {
      ...
      language: "nl",
      avatar: "/demo/images/avatars/3.jpg",
      los: []
    },
    {
      name: "Lenia Böhm",
      language: "de",
      avatar: "/demo/images/avatars/4.jpg",
      los: []
    },
    {
      name: "Julie Marchal",
      language: "fr",
      avatar: "/demo/images/avatars/5.jpg",
      los: [
        {
          resource_type: "TEXT",
    ...
    },
    {
      name: "Aletha Wiegand",
      language: "pl",
      avatar: "/demo/images/avatars/6.jpg",
      los: [
        {
          resource_type: "TEXT",
          title: "South Wales daily news - 1895-07-30",
  ...
  var init = function(options){
    ...
    EuropeanaRS_API.init({debug: true, API_KEY: API_KEY, API_URL: API_URL});
  ...
  var _getUrlParmams = function(){
    var params = {};
    try {
      var paramsArray = location.search.split("?")[1].split("&");
