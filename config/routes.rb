Rails.application.routes.draw do
  ...
  match '/evaluation/step1', to: 'evaluation#step1', via: [:post]
  match '/evaluation/step2', to: 'evaluation#step2', via: [:post]
  match '/evaluation/step3', to: 'evaluation#step3', via: [:post]
