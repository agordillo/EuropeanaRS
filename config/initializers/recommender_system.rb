...
Rails.application.configure do
  ...
  config.settings = {:max_text_length => 50, :max_user_los => 5, :europeanars_database => {:max_preselection_size => 500}, :europeana_database => {:preselection_size => 500}}.recursive_merge(config.settings)
